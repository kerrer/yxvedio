...
public class HomeController extends AbstractBaseController {
  ...
  public String home(ModelMap model) {
    ...
    String url = "http://" + properties.getProperty("red5.server") + ":"
        + properties.getProperty("red5.http.port") + properties.getProperty("webapp.contextPath")
        + "/web/flash/" + channelName;
