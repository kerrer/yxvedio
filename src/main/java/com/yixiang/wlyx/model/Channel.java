...
public class Channel {
  ...
  public String toString() {
    return "Channel [channelName=" + channelName + ", description=" + description + ", enabled="
        + enabled + ", expiresAt=" + expiresAt + ", id=" + id + ", maxUser=" + maxUser
        + ", members=" + members + ", password=" + password + ", recorded=" + recorded
