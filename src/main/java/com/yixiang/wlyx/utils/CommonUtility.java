 ...
 * History	:
 */
package com.yixiang.wlyx.utils;
...
public class CommonUtility {
  ...
  public void updateUserInfo(ObjectMap<String, Object> flexUser, User user) {
    ...
    user.setLoginName(flexUser.get("loginName") != null ? (String) flexUser.get("loginName") : user
        .getLoginName());
    user.setDisplayName(flexUser.get("displayName") != null ? (String) flexUser.get("displayName")
        : user.getDisplayName());
    user.setSex(flexUser.get("sex") != null ? (String) flexUser.get("sex") : user.getSex());
    user.setRole(flexUser.get("role") != null ? getRole((String) ((ObjectMap) flexUser.get("role"))
        .get("name")) : user.getRole());
  ...
  public void updateChannelInfo(ObjectMap<String, Object> flexChannel, Channel channel) {
    ...
    channel.setTitle(flexChannel.get("title") != null ? (String) flexChannel.get("title") : channel
        .getTitle());
    channel.setDescription(flexChannel.get("description") != null ? (String) flexChannel
        .get("description") : channel.getDescription());
    channel.setChannelName(flexChannel.get("channelName") != null ? (String) flexChannel
        .get("channelName") : channel.getChannelName());
    channel.setPassword(flexChannel.get("password") != null ? (String) flexChannel.get("password")
        : channel.getPassword());
    channel.setMaxUser(flexChannel.get("maxUser") != null ? (Integer) flexChannel.get("maxUser")
        : channel.getMaxUser());
    channel.setEnabled(flexChannel.get("enabled") != null ? (Boolean) flexChannel.get("enabled")
        : channel.getEnabled());
    channel.setRecorded(flexChannel.get("recorded") != null ? (Boolean) flexChannel.get("recorded")
        : channel.getRecorded());
