...
public class Connection {
  ...
  public String toString() {
    return "Connection [audioConnection=" + audioConnection + ", audioId=" + audioId + ", id=" + id
        + ", publicConnection=" + publicConnection + ", publicId=" + publicId
        + ", videoConnection=" + videoConnection + ", videoId=" + videoId + "]";
  }
