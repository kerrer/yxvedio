...
public class ChatSOSecurity implements ISharedObjectSecurity {
  ...
  private final static Logger LOG = Red5LoggerFactory.getLogger(ChatSOSecurity.class,
      ChatConstants.APP_NAME);

  /*
   * (non-Javadoc)
   * 
   * @see org.red5.server.api.so.ISharedObjectSecurity#isConnectionAllowed(org.red5.server.api.so.
   * ISharedObject)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see org.red5.server.api.so.ISharedObjectSecurity#isCreationAllowed(org.red5.server.api.IScope,
   * java.lang.String, boolean)
   */
  @Override
  public boolean isCreationAllowed(IScope scope, String name, boolean persistent) {
    try {
      if (name.regionMatches(0, ChatConstants.CHATSO_PREFIX, 0,
          ChatConstants.CHATSO_PREFIX.length())) {
   ...
   * 
   * @see
   * org.red5.server.api.so.ISharedObjectSecurity#isDeleteAllowed(org.red5.server.api.so.ISharedObject
   * , java.lang.String)
   */
  @Override
   ...
   * 
   * @see
   * org.red5.server.api.so.ISharedObjectSecurity#isSendAllowed(org.red5.server.api.so.ISharedObject
   ...
   * 
   * @see
   * org.red5.server.api.so.ISharedObjectSecurity#isWriteAllowed(org.red5.server.api.so.ISharedObject
